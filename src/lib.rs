...
//!     let mut gandolf = commands.spawn_empty()
//!         .set_name("gandolf")
//!         .set_class("wizard")
...
//! }
//!
//! fn system(world: &World) -> Result {
//!     let bilbo = world.entity_named("bilbo")?;
//!     if bilbo.get_prop::<Ustr>("wearing") == "elven_cloak" {
//!         if let Some(talk_target) = bilbo.get_linked("talking_to")
//!             && world.entity(talk_target).get_prop("likes_elves")
//!         {
